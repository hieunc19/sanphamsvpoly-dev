        ...
        <div class="container">
            <div class="major__content__title">
                <div class="content__title__left">
                    <span class="title__item">Tìm Kiếm: <b>{{$keyword}}</b></span>
                    <span class="title__item">Kết quả: <b>{{$couterResult}}</b></span>
                </div>
...
@section('page-script')
    <script>
        ...
        function ajax_rerender_products(keySort,valSort, appendElement){
            ...
            $.ajax({
                url: "{{route('ajax-search-product-sort')}}",
                method: "post",
                data: data,
                dataType: "json",
