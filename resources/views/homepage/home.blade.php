...
@section('title')
    <title>welcome Poly App | Nơi trưng bày dự án sinh viên</title>
@endsection
@section('style-page')
                                ...
                                <a href="/san-pham/{{$item->token}}/view">
                                    ...
                                    <div class="custom-1">
                                        <div class="user">
                                            ...
                                            @endif -->
                                            @if (!isset($item->user_product->avatar) == null)
                                            <p><em>Tác giả</em>: {{ $item->user_product->name }}</p>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="custom-2">
                                        <div class="star">
                                            @for ($i = 0; $i < floor($item->avgStar()); $i++)
                                                <i class="fas fa-star" style="font-size: 13px !important; color: #f9bf03;"></i>
                                            @endfor
                                            ...
                                            @for ($i = 0; $i < 5-round($item->avgStar()); $i++)
                                                <i class="far fa-star" style="font-size: 13px !important; color: #f9bf03;"></i>
                                            @endfor
